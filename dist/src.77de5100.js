...
},{"webrtc-adapter":"../node_modules/webrtc-adapter/src/js/adapter_core.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var regl_1 = __importDefault(require("regl")); // import { GPU } from 'gpu.js';
// const gpu = new GPU();
...
var stepsT = 0;
var stepsQ = 0;
var lastSTm = new Date().getTime(); // const iterateBounce = gpu.createKernel(function(a: number[][][]) {
//   let sum = 0;
//   if(this.thread.z==0){
...
require('getusermedia')({
  ...
  captureNode.onaudioprocess = function (e) {
    ...
    var ave = vu.reduce(function (a, b) {
      return a + b;
    }, 0) / vu.length;
    var nv = [];

    for (var i = 0; i < vu.length; i++) {
      nv[i] = Math.abs(vu[i]) < 0.0 ? 0 : vu[i];
    }
  ...
  function getVolS() {
    ...
    return window.vol[Math.floor(rn % subsamp)] || 0;
  } // source.start();
...
},{"regl":"../node_modules/regl/dist/regl.js","mouse-change":"../node_modules/mouse-change/mouse-listen.js","getusermedia":"../node_modules/getusermedia/getusermedia.js"}],"../../../../.pnpm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.pnpm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
