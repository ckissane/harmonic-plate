...
var lastFm = new Date().getTime(); // const iterateBounce = gpu.createKernel(function(a: number[][][]) {
//   let sum = 0;
//   if(this.thread.z==0){
...
require('getusermedia')({
  ...
  regl.frame(function () {
    ...
    var tm = new Date().getTime(); //   if(tm-lastFm>1000){
    //    console.log("sps",stepsQ,"need",mc*gSize,context.sampleRate/(mc*gSize))
    //     lastFm=tm;
    //     stepsQ=0;
    //   }

    lastSTm = tm; // for(var i=0;i<128;i++){
    //   stepsT+=1/mc/gSize;
    //   stepsQ+=1;
    //   var tm=new Date().getTime();
    //   if(tm-lastSTm>1000){
...
},{"regl":"../node_modules/regl/dist/regl.js","mouse-change":"../node_modules/mouse-change/mouse-listen.js","getusermedia":"../node_modules/getusermedia/getusermedia.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
