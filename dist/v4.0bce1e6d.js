...
},{"webrtc-adapter":"../node_modules/webrtc-adapter/src/js/adapter_core.js"}],"v4.ts":[function(require,module,exports) {
"use strict";
...
var HarmonicPlate = function HarmonicPlate() {
  this.message = 'dat.gui';
  this.detail = 125; // Define render logic ...
};

var harmonicPlate = new HarmonicPlate(); // console.log(GPU);
// const gpu = new GPU();
...
require('getusermedia')({
  ...
  var stream = document.getElementById('sound').captureStream();
  ...
  var fboA = doubleFbo("linear");
  window.fboA = fboA;

  function doubleFbo(filter) {
    var fbos = [createFbo(filter), createFbo(filter)];
    return {
      read: function read() {
        return fbos[0].buf;
      },
      ...
      resize: function resize(width, height) {
        fbos.forEach(function (x) {
          x.tex.resize(width, height);
          x.buf.resize(width, height);
        });
      }
    };
  }
  ...
  function createFbo(filter) {
    var tex = regl.texture({
      type: 'float',
      width: harmonicPlate.detail,
      height: harmonicPlate.detail,
      mag: 'linear'
    ...
    uniforms: {
      ...
      res: function res(_a) {
        var viewportHeight = _a.viewportHeight,
            viewportWidth = _a.viewportWidth;
        return [harmonicPlate.detail, harmonicPlate.detail];
      },
      t: function t(_a) {
        var tick = _a.tick;
        return tick;
  ...
  var magic = function magic() {
    ...
    for (var i = 0; i < 4096; i++) {
      ...
      window.gd = [stepsT * context.sampleRate, window.vol.length]; // if (new Date().getTime() - tm > 1000 / 10) {
      //   break;
      // }
    } //pixels({copy:true})
...
},{"regl":"../node_modules/regl/dist/regl.js","dat.gui":"../node_modules/dat.gui/build/dat.gui.module.js","mouse-change":"../node_modules/mouse-change/mouse-listen.js","getusermedia":"../node_modules/getusermedia/getusermedia.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","v4.ts"], null)
//# sourceMappingURL=/v4.0bce1e6d.js.map